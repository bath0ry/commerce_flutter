...
import 'package:commerce_flutter/view/pages/info_page.dart';
...
class ProductsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<FavItems>(
      builder: ((context, FavItems favItems, Widget? widget) {
                              ...
                              child: Row(
                                children: [
                                  ...
                                  IconButton(
                                      ...
                                      icon: Icon(favItems.favButton.icon))
                                ],
                              ),
                            ),
                          ],
