...
class EletronicsProducts extends StatefulWidget {
  const EletronicsProducts({super.key});

  @override
  State<EletronicsProducts> createState() => _EletronicsProductsState();
}

class _EletronicsProductsState extends State<EletronicsProducts> {
